...
function fetchHighScore() {
  if (typeof Storage !== 'undefined') {
    if (localStorage.highestScoreIntAdv) {
      highScore = Number(localStorage.highestScoreIntAdv);
...
function gameOver() {
  ...
  if (currentScore > highScore) {
    ...
    localStorage.highestScoreIntAdv = currentScore;
    document.querySelector(
      '.streak-message'
...
document.querySelector('.deleteCookies').addEventListener('click', function () {
  highScore = 0;
  localStorage.removeItem('highestScoreIntAdv');
